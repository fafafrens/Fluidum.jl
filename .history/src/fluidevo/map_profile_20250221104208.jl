...
function exponential_tail_pointlike(function_profile,x,xmax; offset = 0.01)
...
function Profiles(x::TabulatedTrento{A,B}, y::TabulatedTrento{A,B}, cent1::Integer, cent2::Integer; radius = range(0,30,100), norm_temp = 1, norm_coll = 1, xmax = 12, exp_tail = true) where {A,B}
    #temperature profile
