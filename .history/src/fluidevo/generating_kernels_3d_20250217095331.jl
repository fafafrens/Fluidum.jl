...
function save_all_particles(;Tmin=1400,Tmax=1420,dT=10, type = "thermal")
    #save_kernels(;Tmin=Tmin,Tmax=Tmax,dT=dT, type = type, file_path="$(@__DIR__)/Kernels_folder/FastReso_kernels/FastReso_OC_kernels/", MC = true)
    ...
    save_kernels_diff(;Tmin=Tmin,Tmax=Tmax,dT=dTT=T,type = type, file_path=string(kernel_path,"/FastReso_HC_kernels/"))
end 
