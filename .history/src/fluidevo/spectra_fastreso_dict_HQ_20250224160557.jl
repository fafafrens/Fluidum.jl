...
@inline function _pointwise_spectra(pt,alpha,x::A,phi::B,part::particle_attribute{S,R,U,V};decays, ccbar = 2.76,delta_f) where {A<:SplineInterp,B<:SplineInterp,S,R,U,V}
    eos = Heavy_Quark()
