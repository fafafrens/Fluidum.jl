...
function matrix1d_visc_grad_p_HQ!(A_i, Source, ϕ, t, X, params;free=true)
    ...
    (At, Ax, source) = one_d_viscous_matrix_ruwen20(ϕ, t, X[1], dpt, dpt, dptt,dPhq_dT, zetaBulkVisc, etaVisc, tauShear, tauBulk, n, dtn, dmn, tauDiff, Ds)
...
function one_d_viscous_matrix_ruwen20(X, tau, r, P_T, dP_dT, dP_dTdT,dPhq_dT, zetaBulkVisc, etaShearVisc, tauShear, tauBulk, n, dn_dT, dn_dmu, tauDiffusion, Ds)
...
(X[1] .*dP_dTdT .*(3 .*tauDiffusion .*tauShear .*tauBulk .*X[2] .*X[7] .*dP_dT  .- Ds .*(3 .*zetaBulkVisc .*tauShear .*X[2] .^2  .+ 4 .*etaShearVisc .*tauBulk .*X[2] .^2  .+ 3 .*tauShear .*tauBulk .*(1  .+ X[2] .^2) .*X[3]  .+ 3 .*tauShear .*tauBulk .*(1  .+ X[2] .^2) .*X[4]  .- 3 .*tauShear .*tauBulk .*X[5]  .- 3 .*tauShear .*tauBulk .*X[2] .^2 .*X[5]  .- 3 .*tauShear .*tauBulk .*X[1] .*dP_dT  .- 3 .*tauShear .*tauBulk .*X[1] .*X[2] .^2 .*dP_dT) .*dPhq_dT)) ./( .-3 .*tauShear .*tauBulk .*X[1] .*X[2] .^2 .*dP_dT .^2  .- X[1] .*(3 .*zetaBulkVisc .*tauShear .*X[2] .^2  .+ 4 .*etaShearVisc .*tauBulk .*X[2] .^2  .+ 3 .*tauShear .*tauBulk .*(1  .+ X[2] .^2) .*X[3]  .+ 3 .*tauShear .*tauBulk .*(1  .+ X[2] .^2) .*X[4]  .- 3 .*tauShear .*tauBulk .*X[5]  .- 3 .*tauShear .*tauBulk .*X[2] .^2 .*X[5]) .*dP_dTdT  .+ 3 .*tauShear .*tauBulk .*dP_dT .*(X[2] .^2 .*X[3]  .+ X[2] .^2 .*X[4]  .- X[2] .^2 .*X[5]  .+ X[1] .^2 .*dP_dTdT  .+ X[1] .^2 .*X[2] .^2 .*dP_dTdT)),
...
(X[2] .*(tauDiffusion .*X[2] .*X[7] .*(3 .*tauShear .*tauBulk .*( .-X[3]  .- X[4]  .+ X[5]) .*dP_dT  .+ 3 .*tauShear .*tauBulk .*X[1] .*dP_dT .^2  .+ (3 .*zetaBulkVisc .*tauShear  .+ 4 .*etaShearVisc .*tauBulk) .*X[1] .*dP_dTdT)  .+ 3 .*Ds .*tauShear .*tauBulk .*(1  .+ X[2] .^2) .*(X[3]  .+ X[4]  .- X[5]  .- X[1] .*dP_dT) .^2 .*dPhq_dT)) ./((1  .+ X[2] .^2) .*(3 .*tauShear .*tauBulk .*X[1] .*X[2] .^2 .*dP_dT .^2  .+ X[1] .*(3 .*zetaBulkVisc .*tauShear .*X[2] .^2  .+ 4 .*etaShearVisc .*tauBulk .*X[2] .^2  .+ 3 .*tauShear .*tauBulk .*(1  .+ X[2] .^2) .*X[3]  .+ 3 .*tauShear .*tauBulk .*(1  .+ X[2] .^2) .*X[4]  .- 3 .*tauShear .*tauBulk .*X[5]  .- 3 .*tauShear .*tauBulk .*X[2] .^2 .*X[5]) .*dP_dTdT  .+ 3 .*tauShear .*tauBulk .*dP_dT .*( .-(X[2] .^2 .*X[3])  .- X[2] .^2 .*X[4]  .+ X[2] .^2 .*X[5]  .- X[1] .^2 .*dP_dTdT  .- X[1] .^2 .*X[2] .^2 .*dP_dTdT))),
...
( .-3 .*tauShear .*tauBulk .*X[2] .*(tauDiffusion .*X[1] .*X[7] .*dP_dTdT  .+ Ds .*X[2] .*( .-X[3]  .- X[4]  .+ X[5]  .+ X[1] .*dP_dT) .*dPhq_dT)) ./( .-3 .*tauShear .*tauBulk .*X[1] .*X[2] .^2 .*dP_dT .^2  .- X[1] .*(3 .*zetaBulkVisc .*tauShear .*X[2] .^2  .+ 4 .*etaShearVisc .*tauBulk .*X[2] .^2  .+ 3 .*tauShear .*tauBulk .*(1  .+ X[2] .^2) .*X[3]  .+ 3 .*tauShear .*tauBulk .*(1  .+ X[2] .^2) .*X[4]  .- 3 .*tauShear .*tauBulk .*X[5]  .- 3 .*tauShear .*tauBulk .*X[2] .^2 .*X[5]) .*dP_dTdT  .+ 3 .*tauShear .*tauBulk .*dP_dT .*(X[2] .^2 .*X[3]  .+ X[2] .^2 .*X[4]  .- X[2] .^2 .*X[5]  .+ X[1] .^2 .*dP_dTdT  .+ X[1] .^2 .*X[2] .^2 .*dP_dTdT)),
