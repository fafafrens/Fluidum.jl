...
function matrix1d_visc_HQ!(A_i,Source,ϕ,t,X,params;dmn_eps=1e-6)
    ...
    kappa = diffusion_hadron(ϕ[1],ϕ[6],params.eos,params.diffusion) #diffusion coefficient for hadrons
...
function one_d_viscous_matrix_fugacity(u,tau,R,p,dtp,dtdtp,dmp,dtdmp,dmdmp,zeta,visc,tauS,tauB,n,dtn,dmn,tauDiff,kappa)
    ...
    Ax=SMatrix{7,7}(
        ...
        ,(-3*dtp*tauB*tauS*(dtdtp*u[1]*(u[7] + n*u[2]*(1 + ^(u[2],2))) + dtn*u[2]*(1 + ^(u[2],2))*(-(dtp*u[1]) - u[5] + u[3] + u[4])))/((1 + ^(u[2],2))*(3*dtp*tauB*tauS*^(u[2],2)*(-(dtp*u[1]) - u[5] + u[3] + u[4]) + dtdtp*u[1]*(3*dtp*u[1]*tauB*tauS*(1 + ^(u[2],2)) - 3*tauS*^(u[2],2)*zeta + tauB*(3*tauS*u[5] - 3*tauS*(u[3] + u[4]) + ^(u[2],2)*(-4*visc + tauS*(3*u[5] + u[3] + u[4]))))))
        ...
        ,(3*dtp*u[7]*tauB*tauS*u[2]*(dtp*u[1] + u[5] - u[3] - u[4]) - 3*dtn*tauB*tauS*(1 + ^(u[2],2))*^(-(dtp*u[1]) - u[5] + u[3] + u[4],2) + dtdtp*u[1]*(3*dtp*u[1]*tauB*tauS*(n - u[7]*u[2] + n*^(u[2],2)) + 3*n*tauB*tauS*(1 + ^(u[2],2))*(u[5] - u[3] - u[4]) + u[7]*u[2]*(4*tauB*visc + 3*tauS*zeta - tauB*tauS*(3*u[5] + u[3] + u[4]))))/((1 + ^(u[2],2))*(3*dtp*tauB*tauS*^(u[2],2)*(-(dtp*u[1]) - u[5] + u[3] + u[4]) + dtdtp*u[1]*(3*dtp*u[1]*tauB*tauS*(1 + ^(u[2],2)) - 3*tauS*^(u[2],2)*zeta + tauB*(3*tauS*u[5] - 3*tauS*(u[3] + u[4]) + ^(u[2],2)*(-4*visc + tauS*(3*u[5] + u[3] + u[4]))))))
        ...
        ,(3*tauB*tauS*(dtdtp*u[1]*(u[7] + n*u[2]*(1 + ^(u[2],2))) + dtn*u[2]*(1 + ^(u[2],2))*(-(dtp*u[1]) - u[5] + u[3] + u[4])))/((1 + ^(u[2],2))*(3*dtp*tauB*tauS*^(u[2],2)*(-(dtp*u[1]) - u[5] + u[3] + u[4]) + dtdtp*u[1]*(3*dtp*u[1]*tauB*tauS*(1 + ^(u[2],2)) - 3*tauS*^(u[2],2)*zeta + tauB*(3*tauS*u[5] - 3*tauS*(u[3] + u[4]) + ^(u[2],2)*(-4*visc + tauS*(3*u[5] + u[3] + u[4]))))))
